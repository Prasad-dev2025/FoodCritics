...
// ==================================================
// LAZY-LOADED MAP MODAL
//
// The Leaflet map library (CSS + JS) is fairly large and
// most customers who type an address never even need to
// see the map. Loading it lazily means that code is only
// downloaded the first time someone actually opens
// "Pick Exact Location" / "Use My Location", instead of
// being part of the app's initial page load.
// ==================================================
...
export default function App() {
  ...
  // Tracks whether the map has ever been opened this
  // session. Once true, the lazy-loaded MapPickerModal
  // stays mounted (toggled via isMapOpen) so its chunk is
  // only fetched once, and close/open animations keep
  // working normally afterward.
  const [hasEverOpenedMap, setHasEverOpenedMap] =
    useState(false);
